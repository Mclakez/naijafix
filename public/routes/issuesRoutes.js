...
//     next()
// })
issuesRouter.post('/', requireAuth, upload.single('issueImage'), lastSeenOnline, checkSuspension, issuesValidator, postIssue)
issuesRouter.get('/', requireAuth, lastSeenOnline, getAllIssues)
issuesRouter.get('/my', requireAuth, lastSeenOnline, getMyIssues)
issuesRouter.patch('/status/:id', requireAuth, checkSuspension, updateIssueStatus)
issuesRouter.get('/:id', requireAuth, lastSeenOnline, checkSuspension, getDetails)
...
issuesRouter.post('/:id/comment', requireAuth, lastSeenOnline,checkSuspension, upload.none(), postComment)
